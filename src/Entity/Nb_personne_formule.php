...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Nb_personne_formuleRepository")
 */
class Nb_personne_formule
{
     ...
     */
    private $id_nb_personne_formule;
    ...
    */
    ...
    public function getId_nb_personne_formule(): ?int
    {
        return $this->id_nb_personne_formule;
    }
